...
export function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative min-h-[100svh] overflow-hidden bg-sage pt-16 lg:pt-20"
    >
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100svh-16rem)] max-w-[1440px] grid-cols-12 gap-x-6 gap-y-0 px-6 lg:gap-10 lg:px-10">
      ...
      <motion.div
        ...
        className="relative z-10 mt-6 overflow-hidden border-y border-ink/20 py-4 lg:mt-8"
      >
